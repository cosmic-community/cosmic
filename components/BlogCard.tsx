...
export default function BlogCard({ post }: BlogCardProps) {
  ...
  // Changed: safely extract author name using TeamMember type directly (no unsafe casts)
        ...
        <div className="flex items-center gap-3 mb-3">
          {author && (
              <div className="flex items-center gap-2">
                {/* Changed: access TeamMember properties directly instead of casting to Record */}
